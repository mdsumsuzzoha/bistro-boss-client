...
const useAxiosSecure = () => {
    ...
    // useEffect(() => {
    //     const interceptorRequest = axiosSecure.interceptors.request.use(function (config) {
    ...
    //     const interceptorResponse = axiosSecure.interceptors.response.use(function (response) {
    //         return response;
    //     }, async (error) => {
